...
class VetoRepository {
    ...
    public function findOneById( int $id)
    {
        ...
        $query = $pdo->prepare('SELECT a_s.id as id, a_s.nourriture as nourriture, a_s.quantitee as quantitee, a_s.state as state, a_s.detail as detail, a_s.date_de_passage as date, a.id as id_animals, a.first_name as name_animals FROM animals_state a_s
    ...
    public function readStateAnimal(){
        ...
        try{
                ...
                $mysql = Mysql::getInstance();
                $pdo = $mysql->getPDO();
                $stmt = $pdo->prepare('SELECT a.id as id_animals, a.first_name as name_animals, a_s.id as id_state,  a_s.animal as animal, a_s.nourriture as nourriture, a_s.quantitee as quantitee, a_s.state as state, a_s.detail as detail, a_s.date_de_passage as date FROM animals_state a_s
                INNER JOIN animals a ON a.id = a_s.animal');
        ...
        public function readStateAdmin(int $id){
            ...
            try{
                    ...
                    $stmt = $pdo->prepare('SELECT a_s.id as id, a_s.nourriture as nourriture, a_s.quantitee as quantitee, a_s.state as state, a_s.detail as detail , a_s.date_de_passage as date , a.first_name as name_animals FROM animals_state a_s
